    ...
    <AlertDialog open={path !== null} onOpenChange={(open) => !open && onCancel()}>
      <AlertDialogContent>
        <AlertDialogHeader>
          ...
          <AlertDialogDescription>
            {path === MAIN_NOTEBOOK
              ? "This is the main notebook the assistant reads in every conversation. Deleting it removes this notebook. Other memory files remain until you delete them too."
